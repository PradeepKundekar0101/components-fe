      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base w-72 leading-relaxed">
          ...
          {/* Popular Tags (Shifted Slightly Left) */}
          <div className="flex justify-start md:col-span-1 ml-[-150px]">
            <div>
              <h3 className="text-white font-medium mb-2 uppercase">Popular Tags</h3>
              <div className="border-t border-gray-700 p-1 w-[500px]"></div>
